node{
    ...
    stage( "Checking into the respective branch of interest" ){
        git branch: 'dockerized_data_retrieval', credentialsId: 'git-creds', url: 'https://github.com/airavata-courses/IU-Witcher-2020/'
    }

    stage( "Building of Docker Image" ){
         sh "docker build -t iuwitcher2020/dockerized_data_retrieval:latest ."
    }
  ...
  sh "docker push iuwitcher2020/dockerized_data_retrieval:latest"
    }
}
