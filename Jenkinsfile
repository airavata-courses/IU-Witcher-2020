node{
    ...
    stage( "Building of Docker Image" ){
         sh "docker build -t iuwitcher2020/iuwitcher2020/dockerized_user_management:latest ."
    }
  ...
  sh "docker push iuwitcher2020/iuwitcher2020/dockerized_user_management:latest"
    }
}
